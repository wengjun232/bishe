...
%         level=wmaxlev(N0,wavename);
    ...
    wa(wa<thr)=0;
    xd=wdencmp('gbl',d,wavename,level,thr,sorh,keepapp);
     wavelet(ch,:)=fix(xd);
    AMDL(ch,:)=mdl;
    catch
        wavelet(ch,:)=d;
...
% save AMDL AMDL;
% save jidi jidi;
% h5create('w-bignoise.h5','/bigwout',[200000,600],'ChunkSize',[10000,600],'Deflate',9);
% h5write('w-bignoise.h5','/bigwout',wavelet);
% 
% 
% 
